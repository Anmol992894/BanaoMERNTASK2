...
// Defining states
    ...
    const register = (event) => {
        ...
        setLoading(true);
        const requestData = {UserName:fullName, Email:email}
        axios.post(`${API_BASE_URL}/forgot`, requestData)
            .then((result) => {
                console.log(result);
                if (result.status == 200) {
                    ...
                    Swal.fire({
                        icon:'success',
                        title:"Password Returned"
                    })
                    setfullName('');
                    setEmail('');
                    setPassword(result.data.result.UserInfo.Password);
                    ...
                    <div className="card shadow">
                        ...
                        <div className="card-body  px-5">
                            ...
                            <form onSubmit={(e) => register(e)}>
                                ...
                                <input disabled type="text" value={password}  className="p-2 mt-4 mb-2 fw-bold form-control input-bg" placeholder='Password' />
                                <div className='mt-3 d-grid'>
                                    <button type='submit' className="custom-btn custom-btn-blue">Get Password</button>
                                </div>
                                <div className='my-4'>
                                ...
                                <div className='mt-3 mb-5 d-grid'>
                                    <button className="custom-btn custom-btn-white">
                                        <span className='text-muted fs-6'>Goto?</span>
